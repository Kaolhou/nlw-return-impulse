...
export function FeedbackSucessStep({onFeedbackSent}:FeedbackSucessStepProps){
    return(
        <>
            <header>
                <CloseButton />
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                <span className="text-x1 mt-2">Agradecemos o Feedback!</span>

                <button
                    onClick={onFeedbackSent}
                    type="button"
                    className="py-2 px-6 mt-6 surface-secundary hover:surface-secundary-hover rounded-md border-transparent text-sm leading-6 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 disabled:opacity-50 disabled:hover:bg-brand-500"
                >
                    Quero enviar outro
                </button>
